...
Examining our individual-level variables, there are some trends to be aware of, as shown in the graphs below. 
...
indiplot3 <- ggplot(individMeans, aes(x = Year, y = AveFam)) + geom_line(colour="#2ca25f") +labs(y = "Percentage with a partner") + theme_bw()
