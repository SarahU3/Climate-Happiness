...
print(plot2, vp = viewport(layout.pos.row = 3, layout.pos.col = 2))
print(plot3, vp = viewport(layout.pos.row = 3, layout.pos.col = 1))
print(plot4, vp = viewport(layout.pos.row = 2, layout.pos.col = 1))
print(plot5, vp = viewport(layout.pos.row = 3, layout.pos.col = 1))
print(plot6, vp = viewport(layout.pos.row = 2, layout.pos.col = 1))
=======
=======
>>>>>>> master
plot6 <- ggplot(data = aggremeans, aes(x=CO2perSqKm, y=satis)) + geom_point() +geom_smooth(colour="#2ca25f") + labs(x = "Emissions per Sq Km", y = "")  + theme_bw()
