...
indiplot3 <- ggplot(individMeans, aes(x = Year, y = AveFam)) + geom_line() +labs(y = "Average family status")
indiplot4 <- ggplot(individMeans, aes(x = Year, y = AveEmp)) + geom_line() +labs(y = "Employment, 1 = unemp, 2 = emp") +ggtitle("Average Employment Status")
multiplot(indiplot1, indiplot2, indiplot3, indiplot4, cols=2)
