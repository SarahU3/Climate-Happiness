...
Interestingly, gender does not appear to have a significant effect on reported life satisfaction in any of the models. The other variables are statistically significant in all the models. For variables other than gender, the directions of the relationships are also the same across models: environment and age have a negative relationship to life satisfaction, while income and having a partner have a positive relationship. Emissions, by either measure, also show a negative relationship. These are simplistic analyses, though, which is why the next section will elaborate further by using multilevel analysis. 
