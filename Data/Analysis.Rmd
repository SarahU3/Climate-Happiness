...
```
Analysis using Saarland, Nordrhein-Westfalen, and Hamburg will have to be done with the missing years in mind. 
...
ggplot(data, aes(x=State, y=Emissions), main = "Emissions by State", xlab = "State", ylab = "Emissions") +geom_boxplot(fill='royalblue') + theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5)) + guides(fill=FALSE)
```
