...
## <img src="Data//HertieCollaborativeDataLogo_v1.png" height="40px" width="20px" />  Models {.smaller.flexbox .vcenter}
...
<div class="black">
$$satis = \beta_0 + \beta_1*Emissions + \beta_2*EnvironConcerns +\beta_3*emp + $$
<br>
$$\beta_4*fam + \beta_5*age + \beta_6*gender + uj + ri$$
</div>
...
``` {r, echo = FALSE, warnings = FALSE, messages = FALSE, error = FALSE, results = 'asis'}
Model.2 <-lme(satis~environ+Emissions+age+fam+emp+gender,random=~age+fam+emp+gender|Stateid,data=data,
             control=list(opt="optim"))
