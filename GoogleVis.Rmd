...
myColourAxis <- paste("{values: [25, 35, 45, 55, 65, 75, 85], ",
...
Animation.playAnimation = function() {
 ...
 + Animation.currentYear + '</b> (Countries with no data shown in white)';
...
plot(
  gvisGeoChart(agg, locationvar = "State", 
               colorvar = "Emissions",
               options=geoChartDE)
  )
