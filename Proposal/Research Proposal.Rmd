...
Individual-level data, such as emissions from primary energy consumption per capita in each Federal State, are available from 1995 to 2012 at the [Working Group on Environmental-Economic Accounting of the Länder]( http://www.ugrdl.de/tab34.htm). Although these numbers are listed in a convenient table and would be a better match for the individual levels of happiness, the data is cross-sectional for each five years, which leaves gaps for other variables. 
